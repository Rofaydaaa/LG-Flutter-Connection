...
import 'package:lg_connection/components/connection_indicator.dart';
import 'package:lg_connection/screens/connection_form_screen.dart';
import 'package:lg_connection/screens/lg_services_screen.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  void _startFlyAnimation() async {
    _controller.reset();
    _controller.forward();
    final orbit = OrbitModel.buildOrbit(OrbitModel.tag());
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const LGServices()),
    );
    //await ssh.goHome();
    print('orbit');
